//
// Created by Adrian Sanchez Anderson on 22/2/18.
//
#include <iostream>
#include <math.h>
#include "calculos.h"
...
template<class T>
 void calculos::calcular2() {
    int n,resp;
    T x;
    while (resp != 1 && resp != 2) {
        cout << "--> Ingrese 1 para asignar valores para n y x. Ingrese 2 para usar el caso de prueba (n=10000000, x=0.00001): ";
        cin>>resp;
